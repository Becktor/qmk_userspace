...
#define LAYOUT_LAYER_BASE                                                                      \\
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, \\
                      SPC_NAV, BSP_NUM, TAB_FUN,     ESC_MED, DEL_NUM, ENT_SYM
...
#define LAYOUT_LAYER_MEDIA                                                                       \\
    ...
    XXXXXXX, XXXXXXX, XXXXXXX,  EE_CLR, QK_BOOT,     QK_BOOT,  EE_CLR, XXXXXXX, XXXXXXX, XXXXXXX, \\
             XXXXXXX, KC_MPLY, KC_MSTP,      KC_MSTP, KC_MPLY, XXXXXXX

/** \brief Mouse emulation and pointer functions. */
#define LAYOUT_LAYER_POINTER                                                                     \\
    QK_BOOT,  EE_CLR, XXXXXXX, DPI_DEC, S_D_MOD,     S_D_MOD, DPI_INC, XXXXXXX,  EE_CLR, QK_BOOT, \\
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    switch (get_highest_layer(state)) {
        case LAYER_BASE:
            ...
            rgb_matrix_set_color_all(HSV_WHITE);
            break;
        case LAYER_FUNCTION:
